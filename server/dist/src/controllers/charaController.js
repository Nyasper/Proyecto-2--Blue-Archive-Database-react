...
exports.charaController = void 0;
const charaService = __importStar(require("../services/studentService"));
const categories_1 = require("../services/categories");
function charaController(app) {
...
exports.charaController = charaController;
